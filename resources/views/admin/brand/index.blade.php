...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">All Brand</h1>
            </div>
            <div class="col-sm-6">
                        ...
                        <div class="col-sm-12 col-md-4">
                            <form action="" method="get">
                                <div class="input-group mb-3 input-group">
                                    <input type="text" class="form-control" name="search" placeholder="Search brand">
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $brand->id }}</td>
                                <td>{{ $brand->name }}</td>
                                <td>{{ $brand->created_by }} <small>({{ $brand->created_at->format('M d, Y') }})</small> </td>
                                <td>
                                    @if ($brand->updated_by)
                                        {{ $brand->updated_by }} <small>({{ $brand->updated_at->format('M d, Y') }})</small>
                                    @else
                                        ---------------
                                    @endif
                                </td>
